...
<body>
    <h2> (5.)passenger names for those who do not have any bookings in any flights</h2>
...
$sql1 = "SELECT p_name
FROM passenger
WHERE p_id NOT IN (SELECT p_id FROM booking);";
   ...
   // if (mysqli_num_rows($res) > 0) { 
      ...
      //  echo "<tr>"; 
       ...
       // echo "<th>flight_date</th>"; 
        ...
        //echo "</tr>"; 
       // echo " (5.)passenger names for those who do not have any bookings in any flights";
