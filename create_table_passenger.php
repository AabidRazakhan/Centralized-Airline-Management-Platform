  ...
  <body>
    ...
    <section class="container">
      ...
      <form method="POST" class="form" onsubmit="return openPopup()">
        <div class="input-box">
          <label>p_id</label>
          <input type="number" placeholder="Enter Passenger id"  name="ni" required  />
        </div>
        ...
        <label>p_gender</label>
          <input type="text" placeholder="Enter gender"  name="gn" required />
        </div>
        <div class="input-box address">
          <label>p_city</label>
            <input type="text" placeholder="Enter your city"  name="ci" required />
          </div>
        <button><input type="submit" value="Submit" name="sb"></button>
