...
$dbname="dbms";
    ...
    if ($result->num_rows == 0) {
        ...
        $createTableSql = "Create Table agency (a_id varchar(10) primary key, a_name	varchar(30) not null, a_city varchar(15) not null)";
    ...
    <form method="POST">
        ...
        <button><a href="http://localhost/php%20code/agency_drop.php">Drop</button></a> 
    </form>
